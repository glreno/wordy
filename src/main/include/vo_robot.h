...
typedef struct vo_robot_struct {
    ...
    byteunion laserTargetCoords; // offsets 0x38,39; 0 if not drawing laser
} vo_robot;
...
void __fastcall__ vor_initialize(vo_robot *this, char y, ds_page **pages, unsigned char*screenram);
